...
weights = {20, 10};
% o = 1;
wws = intersect(linspace(0.35, 3.5, 4), linspace(3.5, 35, 4));
deltas = intersect(linspace(0.008, 0.08, 4), linspace(0.08, 0.8, 4));
dd = 4;
for ww = 1 : 7
    for o = 1 : length(f)
        for i = 1 : length(file_names)
            ...
            for j = 1 : length(list)
                ...
                wss(j) = main_ws3(filename, index, f{o}, weights);
            end
            ws_cell{o, i} = wss;
        end
    end
