function wind_speed = main_ws4(filename, index, f, weights, wws, dds, choice)
% Parameters
Gamma = 0.98;
Phi = 200;
Epsilon = -0.1;
...
for itration = 1 : iters
     ...
     % 加入后续的风速
     if choice == 0
        wind_speed = qxrd_bz_bb_beta3(type, index, P, f, weights, wws, dds);
     elseif choice == 1
         wind_speed = qxrd_bz_bb_beta4(type, index, P, f, weights, wws, dds);
     elseif choice == 2
         wind_speed = qxrd_bz_bb_beta5(type, index, P, f, weights, wws, dds);
     end
end
end